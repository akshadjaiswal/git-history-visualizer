        ...
        <div className="space-y-8">
          {milestones.map((milestone, index) => (
            <div key={index} className="relative pl-14">
              {/* Circle marker */}
              <div className="absolute left-0 w-12 h-12 border-2 border-white bg-black flex items-center justify-center">
                <div className="w-4 h-4 bg-white" />
              </div>

              {/* Content */}
              <div>
                <div className="font-display text-lg font-bold">{milestone.label}</div>
